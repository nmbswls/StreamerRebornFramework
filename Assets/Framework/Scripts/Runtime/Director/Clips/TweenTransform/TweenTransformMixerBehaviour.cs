...
namespace My.Framework.Runtime.Director
{
    public class TweenTransformMixerBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            {
                ScriptPlayable<TweenTransformBehaviour> playableInput = (ScriptPlayable<TweenTransformBehaviour>)playable.GetInput(i);
                TweenTransformBehaviour input = playableInput.GetBehaviour();
